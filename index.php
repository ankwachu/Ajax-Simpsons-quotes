...
<body>
  <section class="section">
    <div class="container">
      ...
      <div class="content" id="chuck-norris"></div>
        <button id="btn">Reload for another joke!</button>
    </div>
  </section>
  ...
  <script>
          ...
          axios.get(url)
              ...
              .then(function(jokes) {
                  ...
                  document.querySelector('#chuck-norris').innerHTML = `
                        ...
                        <p id="content"><strong>${jokes.value}</strong></p>
                        `;
              });
      }
      ...
      document.getElementById("btn").addEventListener("click", function () {
          document.getElementById("content").innerHTML = fetchChuckNorrisFactsJSON();
      });
  </script>
</body>
</html>